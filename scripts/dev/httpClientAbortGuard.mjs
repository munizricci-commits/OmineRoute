...
/**
 * Dev/prod server crash guard (#fix-dev-server-aborted).
 *
 ...
 *      client-abort errors so they never bubble to the process level.
 ...
 *      crash semantics (so genuine bugs still surface).
 *
 * Reusable by any Node http server in the codebase (apiBridgeServer, etc.).
 */
